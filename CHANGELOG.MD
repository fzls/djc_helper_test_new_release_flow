# 更新公告
1. 增加一个提取更新信息的脚本，方便github release流程使用
2. 移除更新内容中固定的部分
3. 日志来源改为使用下面详细列出的部分，并添加版本对比
4. 如需购买自动更新DLC或按月付费，请在配置工具的【付费相关】标签页自助购买，具体流程请查阅目录中【付费指引.docx】
5. 其他改动及上述功能具体用法，详见README.MD和CHANGELOG.MD以及使用教程/使用文档.docx和教程视频
